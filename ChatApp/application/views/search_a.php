...
<!--                        <div class="search_result_subrow">
            ...
            -->
                            ...
                            <a href="<?php echo base_url();?>getData/getAnimalProfile?id=<?php echo $result['earTag'.$i]?>"><p class="info-label"><button type="button"  class="btn-success" name="search_by_selector" > See Animal Profile </button></p></a>
